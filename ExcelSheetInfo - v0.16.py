...
if __name__ == "__main__":
    ...
    workbook_path = r"C:\Users\Martin56\Dropbox (Scalar Analytics)\Oficina\Referencia y training\Martin\Python\AI-Research\Test1.xlsx"

    company_name = "SALABANYA"    
    ...
    # for key, value in workbook_sheets_excel['2023 BS'].items():
    #     print(f"{key} - {value}")
